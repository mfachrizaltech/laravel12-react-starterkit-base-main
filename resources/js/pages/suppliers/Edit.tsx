...
const UpdateSupplierPage: React.FC<Props> = ({
  rules, supplier  
}) => {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    { title: __('supplier.edit_supplier'), href: route('suppliers.index') },
  ];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={__('supplier.edit_supplier')} />
      <Toast ref={toast} />

      <div className="form-group">
        <h2 className="text-xl font-bold mb-4">{__('supplier.edit_supplier')}</h2>
