...
const CreateCodePage: React.FC<Props> = ({
  rules,   
}) => {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    { title: __('code.add_new_code'), href: route('codes.index') },
  ];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={__('code.add_new_code')} />
      <Toast ref={toast} />

      <div className="form-group">
        <h2 className="text-xl font-bold mb-4">{__('code.add_new_code')}</h2>
