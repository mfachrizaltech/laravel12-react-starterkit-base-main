...
const CreatePermissionPage: React.FC<Props> = ({
  rules,  
  moduleOptions,
}) => {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    { title: __('permission.add_new_permission'), href: route('permissions.index') },
  ];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={__('permission.add_new_permission')} />
      <Toast ref={toast} />

      <div className="form-group">
        <h2 className="text-xl font-bold mb-4">{__('permission.add_new_permission')}</h2>
