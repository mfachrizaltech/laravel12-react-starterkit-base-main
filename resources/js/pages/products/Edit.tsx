...
const EditProductPage: React.FC<Props> = ({ rules, product }) => {
  ...
  const breadcrumbs: BreadcrumbItem[] = [
    { title: __('product.edit_product'), href: route('products.index') },
  ];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={__('product.edit_product')} />
      <Toast ref={toast} />

      <div className="form-group">
        <h2 className="text-xl font-bold mb-4">{__('product.edit_product')}</h2>
