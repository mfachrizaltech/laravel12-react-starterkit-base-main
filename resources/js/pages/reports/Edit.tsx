...
const EditReportPage: React.FC<Props> = ({rules, report}) => { 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setClientErrors({});
    put(route('reports-maintenance.update', report.id), {
      preserveScroll: true, 
    });
  };
  ...
  return ( 
    <AppLayout>
      <Head title={__('report.edit_report')}/>
      <Toast ref={toast} />

      <div className="form-group">
        <h2 className="text-xl font-bold mb-4">{__('report.edit_report')}</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-2">
            ...
            />
            <AuthButton
              permission='reports-maintenance.update' 
